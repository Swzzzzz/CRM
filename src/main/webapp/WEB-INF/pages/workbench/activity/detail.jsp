		...
		$("#saveActivityRemarkBtn").click(function () {
			...
			$.ajax({
				...
				success:function (data) {
					...
					html+="<a remarkId=\""+data.retData.id+"\" name=\"editA\" class=\"myHref\" href=\"javascript:void(0);\"><span class=\"glyphicon glyphicon-edit\" style=\"font-size: 20px; color: #E6E6E6;\"></span></a>";
					html+="&nbsp;&nbsp;&nbsp;&nbsp;";
					html+="<a remarkId=\""+data.retData.id+"\" name=\"deleteA\" class=\"myHref\" href=\"javascript:void(0);\"><span class=\"glyphicon glyphicon-remove\" style=\"font-size: 20px; color: #E6E6E6;\"></span></a>";
					html+="</div>";
					html+="</div>";
					html+="</div>";
...
<body>
	...
	<div class="modal fade" id="editRemarkModal" role="dialog">
		<%-- 备注的id --%>
		<input type="hidden" id="hide_remarkId">
